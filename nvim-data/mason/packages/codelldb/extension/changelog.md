...
### New
- Added `start_debugging()` function to CodeLLDB's [Python API](https://github.com/vadimcn/codelldb/blob/v1.12.1/MANUAL.md#debugger-api).   This translates into the [StartDebugging](https://microsoft.github.io/debug-adapter-protocol/specification#Reverse_Requests_StartDebugging) DAP request.
- [Step Into Targets](https://code.visualstudio.com/updates/v1_46#_step-into-targets) now works on ARM platforms.

### Fixed
- [#1357](https://github.com/vadimcn/codelldb/issues/1357): can't watch contents of pointers
- [#1364](https://github.com/vadimcn/codelldb/issues/1364): get_source_text panic due to unwrap on unknown/empty opcode
- Codelldb will now unblock the signal specified in `gracefulShutdown` before delivering it to the debuggee.

# 1.12.0

### New
- [Vibe debugging!](https://github.com/vadimcn/codelldb/blob/v1.12.1/MANUAL.md#agent-assisted-debugging)
- [Graceful shutdown](https://github.com/vadimcn/codelldb/blob/v1.12.1/MANUAL.md#graceful-shutdown)
- Added automatic [propagation of RPC server configuration](https://github.com/vadimcn/codelldb/blob/v1.12.1/MANUAL.md#rpc-server) to `codelldb-launch` (integrated terminal only).

### Changed
- Updated bundled LLDB to v21.1.
- Reworked [simple expressions](https://github.com/vadimcn/codelldb/blob/v1.12.1/MANUAL.md#simple-expressions) to be more aligned with LLDB's
...
- Added `codelldb-launch` CLI for working with CodeLLDB's RPC endpoints.  See details in the [manual](https://github.com/vadimcn/codelldb/blob/v1.12.1/MANUAL.md#codelldb-launch).
...
## New
- Implemented [Excluded Callers](https://github.com/vadimcn/codelldb/blob/v1.12.1/MANUAL.md#excluded-callers) feature, similar to the
  [one in Javascript debugger](https://code.visualstudio.com/updates/v1_64#_javascript-debugging).
- Added [create_webview()](https://github.com/vadimcn/codelldb/blob/v1.12.1/MANUAL.md#webview) Python API, which allows scripts to create and manipulate VSCode Webviews.
...
- Added experimental `split` option to the [`consoleMode`](https://github.com/vadimcn/codelldb/blob/v1.12.1/MANUAL.md#general) config setting.  In this mode the debug console
  will be used for evaluation of expressions and a separate terminal will be created for input of LLDB commands.

## Changed
- ["Simple" expressions](https://github.com/vadimcn/codelldb/blob/v1.12.1/MANUAL.md#simple-expressions)" now use a proper parser, which should make syntax error messages less confusing.
...
- The `show_debug_info` [command](https://github.com/vadimcn/codelldb/blob/v1.12.1/MANUAL.md#debugger-commands) has been renamed to `debug_info`, with sub-commands `list` and `show`.
...
- Added UI for [console mode](https://github.com/vadimcn/codelldb/blob/v1.12.1/MANUAL.md#debug-console) switching.
...
- Added [`debug_info`](https://github.com/vadimcn/codelldb/blob/v1.12.1/MANUAL.md#debugger-commands) LLDB command, that makes it easier to determine which modules have debug info available.
...
- Upon completing a request, the [RPC server](https://github.com/vadimcn/codelldb/blob/v1.12.1/MANUAL.md#rpc-server) will now respond with a status message.
...
- Added [RPC server](https://github.com/vadimcn/codelldb/blob/v1.12.1/MANUAL.md#rpc-server) for "external" launching.
...
## Other
- [Version 5.3](https://github.com/mozilla/rr/releases/tag/5.3.0) of Mozilla's [rr](https://rr-project.org/) has been released a few days ago.  It seems to work pretty well with CodeLLDB's [reverse debugging](https://github.com/vadimcn/codelldb/blob/v1.12.1/MANUAL.md#reverse-debugging) support.
...
- The `.../command` [URL handler](https://github.com/vadimcn/codelldb/blob/v1.12.1/MANUAL.md#starting-debug-session-outside-of-vscode) now supports setting debuggee environment variables.
...
- Added URL handler for [starting a debug session from outside of VSCode](https://github.com/vadimcn/codelldb/blob/v1.12.1/MANUAL.md#starting-debug-session-outside-of-vscode).<br>
...
# 0.8.8
- Added [`postRunCommands`](https://github.com/vadimcn/codelldb/blob/v1.12.1/MANUAL.md#launching).
- Bug fixes.
...
# 0.8.5
- Added support for [Cargo projects](https://github.com/vadimcn/codelldb/blob/v1.12.1/MANUAL.md#cargo-support).
...
- Added `expressions` ∈ { `simple`, `python`, `native` } launch configuration property, which selects the default
  [expression evaluator type](https://github.com/vadimcn/codelldb/blob/v1.12.1/MANUAL.md#expressions).
...
# 0.8.0
- Added [Parameterized Launch Configurations](https://github.com/vadimcn/codelldb/blob/v1.12.1/MANUAL.md#parameterized-launch-configurations).
...
# 0.7.4
- It is now possible to set [default values for launch configurations](https://github.com/vadimcn/codelldb/blob/v1.12.1/MANUAL.md#workspace-configuration) per-workspace.
...
# 0.3.3
- [Custom launch requests](https://github.com/vadimcn/codelldb/blob/v1.12.1/MANUAL.md#custom-launch).
...
# 0.3.2
- Added pickProcess and pickMyProcess commands to be used with the **pid** parameter when [attaching](https://github.com/vadimcn/codelldb/blob/v1.12.1/README.md#attaching).
...
# 0.3.0
- [Variable visualizers for Rust](https://github.com/vadimcn/codelldb/blob/v1.12.1/MANUAL.md#rust-language-support).
- New [expression evaluator](https://github.com/vadimcn/codelldb/blob/v1.12.1/MANUAL.md#expressions).
- Bug fixes.
...
# 0.2.0
- Added [disassembly view](https://github.com/vadimcn/codelldb/blob/v1.12.1/MANUAL.md#disassembly-view).
- Added [variable formatting](https://github.com/vadimcn/codelldb/blob/v1.12.1/MANUAL.md#formatting).

# 0.1.3
- Added support for setting variable values (primitive types only).
- Added [regex breakpoints](https://github.com/vadimcn/codelldb/blob/v1.12.1/MANUAL.md#regex-breakpoints).
